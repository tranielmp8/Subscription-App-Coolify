...
<div class="mx-auto max-w-2xl">
	<div class="mb-6">
		...
		<h1 class="mt-2 text-2xl font-black text-slate-100">Add Subscription</h1>
	</div>
	...
	<form method="POST" use:enhance class="space-y-5">
		...
		<section class="rounded-xl card-dark p-6">
			...
			<div class="space-y-4">
				<div>
					...
					<input id="name" name="name" type="text" required placeholder="Netflix, Spotify, Adobe CC…"
				...
				<div>
					...
					<textarea id="description" name="description" rows="2" placeholder="Optional notes about this subscription"
						class="w-full rounded-xl border border-violet-900/30 bg-[var(--surface)] px-3 py-2.5 text-sm text-slate-200 placeholder:text-slate-600 focus:border-violet-500 focus:ring-2 focus:ring-violet-500/20 focus:outline-none transition-all"></textarea>
				</div>
		...
		<section class="rounded-xl card-dark p-6">
			...
			<p class="mb-5 text-xs text-slate-600">Optional — passwords are encrypted at rest.</p>
			<div class="space-y-4">
				<div>
			...
			{#if notifEnabled}
				<div class="space-y-4">
					<div>
						...
						<input id="notification_email" name="notification_email" type="email" required={notifEnabled} placeholder="you@example.com"
							class="w-full rounded-xl border border-violet-900/30 bg-[var(--surface)] px-3 py-2.5 text-sm text-slate-200 placeholder:text-slate-600 focus:border-violet-500 focus:ring-2 focus:ring-violet-500/20 focus:outline-none transition-all" />
					</div>
					<div>
					...
					<div class="grid gap-4 sm:grid-cols-2">
						<div>
							...
							<input id="notification_time" name="notification_time" type="time" value="08:00" step="900"
								class="w-full rounded-xl border border-violet-900/30 bg-[var(--surface)] px-3 py-2.5 text-sm text-slate-200 focus:border-violet-500 focus:ring-2 focus:ring-violet-500/20 focus:outline-none transition-all" />
						</div>
						<div>
		...
		<div class="flex gap-3">
			...
			<a href="/dashboard" class="rounded-xl border border-violet-900/30 bg-[var(--subtle-hover)] px-6 py-2.5 text-sm font-semibold text-slate-400 hover:bg-[var(--subtle-strong)] hover:text-slate-200 transition-all">
				Cancel
			</a>
		</div>
	</form>
